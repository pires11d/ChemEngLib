...
s = Stream([s,o])
s.wi = [1.0,0.0]
s.Vf = VolumeFlow(110.0).m3_h
#endregion

#region TANK
from UnitOp import *
#tk = Hopper(initial_angle=30,final_angle=60,Hmin=0.8,Hmax=1.0,r1=3.0,r2=5.5,R=6.0)
#tk = recTank(1.0,1.0,1.5)
tk = cylTank(2.0,2.0,45)
tk.Mixture = m
tk.Inlets = [s]
...
ax = plt.axes(xlim=(-2, 2), ylim=(-0.5, 3.5))
def init():
